...
config = read_toml_config("C:/Users/romah/Desktop/pythonProjectSQL/LocalServer/config.toml")
...
async def startup() -> None:
    ...
    if not os.path.exists("C:/Users/romah/Desktop/pythonProjectSQL/LocalServer/startup.sql"):
        ...
        async with aiosqlite.connect(DATABASE_PATH) as database:
            ...
            with open("C:/Users/romah/Desktop/pythonProjectSQL/LocalServer/startup.sql", "r", encoding="utf-8") as file:
